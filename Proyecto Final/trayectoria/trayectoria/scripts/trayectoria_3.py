...
def safe_distance(targetX,targetY,x1,y1,x2,y2,x4,y4,x5,y5,x6,y6,theta1,theta2,theta4,theta5,theta6):
	...
	if(distance_to_1 < 1.1 or distance_to_2 < 1.1 or distance_to_4 < 1.1 or distance_to_5 < 1.1 or distance_to_6 < 1.1):
...
if __name__ == '__main__':
	...
	while(distance>0.5):	
		safe_distance(targetX,targetY,x1,y1,x2,y2,x4,y4,x5,y5,x6,y6,theta1,theta2,theta4,theta5,theta6)
