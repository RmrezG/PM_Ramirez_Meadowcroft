...
def safe_distance(valor):
	...
	if(distance_to_1 < 0.3 or distance_to_2 < 0.3 or distance_to_4 < 0.3 or distance_to_5 < 0.3 or distance_to_6 < 0.3):
		time.sleep(1)
...
if __name__ == '__main__':
	...
	while(distance < 0.01):
		safe_distance()
		orientate(x + 0.1*targetX + esquivaX, y + 0.1*targetY + esquivaY)
		time.sleep(0.1)
		go_to_goal(x + 0.1*targetX + esquivaX, y + 0.1*targetY + esquivaY)
		time.sleep(0.1)
