...
if __name__ == '__main__':
	...
	print('Inserta longitud: ')
	length = input()
	xI = x
	yI = y
	
	print('Inserta modalidad de trayectoria (Horario = 1 / Antihorario = 0): ')
	modo = input()
	...
	if(modo == 0):
		...
		if(xI>5.25):
			...
			if(yI>5.25):
				...
				orientate(x,y-length)
				time.sleep(0.4)
				orientate(x,y-length)
				time.sleep(0.1)
				go_to_goal(xg,yg-length)
				time.sleep(0.1)
